/*
 ...
 Source Server         : demosql
 Source Server Type    : MySQL
 Source Server Version : 90200
 Source Host           : localhost:3306
 Source Schema         : demo_info

 Target Server Type    : MySQL
 Target Server Version : 90200
 File Encoding         : 65001

 Date: 12/06/2025 07:59:16
*/
...
CREATE TABLE `friend`  (
  ...
  `back` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `user`  (
  ...
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ':/res/head_1.jpg',
  PRIMARY KEY (`id`) USING BTREE,
...
END IF;
            ...
            -- 在user表中插入新记录
            INSERT INTO `user` (`uid`, `name`, `email`, `password`) VALUES (@new_id, new_name, new_email, new_password);
            -- 设置result为新插入的uid
